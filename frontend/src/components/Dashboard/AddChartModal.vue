...
const numberCharts = [
  ...
  { label: __('Rejected: No Time'), value: 'calls_rejected_time' },
  { label: __('Rejected: Budget'), value: 'calls_rejected_budget' },
  { label: __('Rejected: Interest'), value: 'calls_rejected_interest' },
  { label: __('Rejected: Need'), value: 'calls_rejected_need' },
